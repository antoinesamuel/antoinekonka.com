...
export function ServicesSection() {
  ...
  return (
    ...
    >
      ...
      <h2
        ref={h2Ref}
        className="text-[4.5rem] xl:text-[6.5rem] tracking-tight max-w-4xl xl:max-w-6xl mb-16 leading-tight text-white text-center md:text-start"
      >
        My Job ? Understand, Analyze, design aesthetic, and acessibles solutions
        for my clients.
      </h2>
